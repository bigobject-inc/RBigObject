...
##' @keywords internal
##' @export
#setMethod("make.db.names", c("BigObjectConnection", "character"),
#  function(dbObj, snames, keywords, unique, allow.keywords, ...) {
#    make.db.names.default(snames, .BigObjectKeywords, unique, allow.keywords)
#  }
#)
#
##' @export
##' @rdname make.db.names-BigObjectConnection-character-method
#setMethod("SQLKeywords", "BigObjectConnection", def = function(dbObj, ...) {
#  .BigObjectKeywords
#})
#
##' @export
##' @rdname make.db.names-BigObjectConnection-character-method
#setMethod("isSQLKeyword", c("BigObjectConnection", "character"),
#  function(dbObj, name, keywords = .BigObjectKeywords, case, ...) {
#    isSQLKeyword.default(name, keywords = .BigObjectKeywords, case = case)
#  }
#)
#
### the following reserved words were taken from Section 6.1.7
### of the BigObject Manual, Version 4.1.1-alpha, html format.
#.BigObjectKeywords <- c("ADD", "ALL", "ALTER", "ANALYZE", "AND", "AS", "ASC",
